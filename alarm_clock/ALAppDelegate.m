...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    if(count == 0) {
        ...
        for (NSManagedObject *user in fetchedObjects) {
            ...
            NSLog(@"Phone: %@", [user valueForKey:@"phone"]);
            NSManagedObject *alarms = [user valueForKey:@"alarms"];
            NSLog(@"Alarms: %@", [alarms valueForKey:@"time"]);
        }
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"alarm_clock" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"alarm_clock.sqlite"];
